--[[
	...
	Revision: $Id: SearcherProspect.lua 5498 2014-10-18 13:24:18Z brykrys $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.21d2/Auc-Util-SearchUI/SearcherProspect.lua $", "$Rev: 5498 $")
